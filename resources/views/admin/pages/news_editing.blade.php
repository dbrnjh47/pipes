					...
					<div class="kt-portlet__body">
						...
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<div class="kt-input-icon">
									<textarea type="text" class="form-control" name="short_description">{{$news->short_description}}</textarea>
						...
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<div class="kt-input-icon">
									<input type="datetime" class="form-control" name="created_at" value="{{$news->created_at}}">
