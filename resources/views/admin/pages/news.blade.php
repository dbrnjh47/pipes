...
<script src="/temple/pk/admin/dash/js/ajax-news.js?v=<?php echo time() ?>" type="text/javascript"></script>
            ...
            <form class="kt-form-new" method="post" enctype="multipart/form-data" action="/admin/news/add">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" required placeholder="text" name="short_description">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="created_at">Дата новости:</label>
